...
set(MSG_I_FLAGS "-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Iintera_core_msgs:/home/paul/sawyerDemo/src/intera_common/intera_core_msgs/msg;-Iintera_core_msgs:/home/paul/sawyerDemo/src/cmake-build-debug/devel/share/intera_core_msgs/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg;-Iactionlib_msgs:/opt/ros/noetic/share/actionlib_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/paul/sawyerDemo/src/dynamics/srv/getStaticTorques.srv" NAME_WE)
add_custom_target(_dynamics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamics" "/home/paul/sawyerDemo/src/dynamics/srv/getStaticTorques.srv" ""
)

get_filename_component(_filename "/home/paul/sawyerDemo/src/dynamics/srv/setTorques.srv" NAME_WE)
add_custom_target(_dynamics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "dynamics" "/home/paul/sawyerDemo/src/dynamics/srv/setTorques.srv" ""
)
...
_generate_srv_cpp(dynamics
  "/home/paul/sawyerDemo/src/dynamics/srv/getStaticTorques.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/dynamics
)
_generate_srv_cpp(dynamics
  "/home/paul/sawyerDemo/src/dynamics/srv/setTorques.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/dynamics
)
...
if(TARGET intera_core_msgs_generate_messages_cpp)
  add_dependencies(dynamics_generate_messages_cpp intera_core_msgs_generate_messages_cpp)
endif()
...
if(TARGET intera_core_msgs_generate_messages_eus)
  add_dependencies(dynamics_generate_messages_eus intera_core_msgs_generate_messages_eus)
endif()
...
if(TARGET intera_core_msgs_generate_messages_lisp)
  add_dependencies(dynamics_generate_messages_lisp intera_core_msgs_generate_messages_lisp)
endif()
...
if(TARGET intera_core_msgs_generate_messages_nodejs)
  add_dependencies(dynamics_generate_messages_nodejs intera_core_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dynamics)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/dynamics\")")
  # install generated code
  install(
...
if(TARGET intera_core_msgs_generate_messages_py)
  add_dependencies(dynamics_generate_messages_py intera_core_msgs_generate_messages_py)
endif()
